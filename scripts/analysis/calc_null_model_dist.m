...
% 		% Bassoon matrices
% 		if ~isempty(SFIE{2})
% 			SFIE_mat(isesh,:) = SFIE{2}.rate;
% 			energy_mat(isesh,:) = energy{2}.rate;
% 			lat_mat(isesh,:) = lat_inh{2}.rate;
% 
% 			% Data
% 			params_NT = data{14, 2};
% 			data_NT = analyzeNT(params_NT);
% 			data_mat(isesh, :) = data_NT.rate;
% 		end
